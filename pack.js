...
function build_game() {
    execute(`/Applications/CocosCreator2.2.2.app/Contents/MacOS/CocosCreator --path ./ --build "platform=android;debug=true;previewWidth=720;previewHeight=1280;apiLevel=30"`)
